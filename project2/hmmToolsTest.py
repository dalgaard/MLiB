import unittest
from project2.hmmTools import Hmm
...
class HmmLoaderTestCase(unittest.TestCase):
    ...
    def test_pi(self):
        self.assertEqual(self.hmm.pi, [0.496359, 0.188095, 0.315546])
        
    def test_transitions(self):
        expected = [[0.990971, 0.009029, 0.000000],
                    [0.023083, 0.953090, 0.023827],
                    [0.000000, 0.013759, 0.986241]]
        self.assertEqual(self.hmm.A ,expected, 'incorrect transitions')
        
    def test_emissions(self):
        expected = [[0.043601,0.011814,0.053446,0.065541,0.049508,0.049789,0.054571,0.024191,0.055977,0.035162,0.103235,0.045007,0.029536,0.048101,0.075105,0.059634,0.068354,0.016315,0.067792,0.043319],
        ...
        self.assertEqual(self.hmm.emissions, expected, 'incorrect emissions')